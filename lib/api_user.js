...
exports.createUser = async function (user) {
  ...
  let url = this.prefix + 'user/create?access_token=' +  accessToken;
...
exports.updateUser = async function (user) {
  ...
  let url = this.prefix + 'user/update?access_token=' +  accessToken;
  return this.request(url, postJSON(user));
};
...
exports.deleteUser = async function (id) {
  ...
  let url = this.prefix + 'user/delete?access_token=' +  accessToken;
  let data =  {
    userid: id
  };
  return this.request(`${url}&${querystring.stringify(data)}`);
};
...
exports.deleteUser = async function (users) {
  ...
  let url = this.prefix + 'user/batchdelete?access_token=' +  accessToken;
  let data = {
    useridlist : users
  };
  return this.request(`${url}&${querystring.stringify(data)}`);
...
exports.getUser = async function (id) {
  ...
  let url = this.prefix + 'user/get?access_token=' +  accessToken;
  let data = {
    userid: id
  };
  return this.request(`${url}&${querystring.stringify(data)}`);
...
exports.getDepartmentUsers = async function (departmentId, fetchChild, status) {
  ...
  let url = this.prefix + 'user/simplelist?access_token=' +  accessToken;
  let data = {
...
exports.getDepartmentUsersDetail = async function (departmentId, fetchChild, status) {
  ...
  let url = this.prefix + 'user/list?access_token=' +  accessToken;
  let opts = {
    department_id: departmentId,
      fetch_child: fetchChild,
      status: status
...
exports.inviteUser = async function (id, invite_tips) {
  ...
  let url = this.prefix + 'invite/send?access_token=' +  accessToken;
  let opts = {
    userid: id,
